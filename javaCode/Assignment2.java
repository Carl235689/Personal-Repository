...
public class Assignment2 {
    ...
    double d12 = displayedDistanceBetween(plane1, plane2);
    double d13 = displayedDistanceBetween(plane1, plane3);
    double d23 = displayedDistanceBetween(plane2, plane3);
    ...
    double nd12 = displayedDistanceBetween(plane1, plane2);
    double nd13 = displayedDistanceBetween(plane1, plane3);
    double nd23 = displayedDistanceBetween(plane2, plane3);
    ...
    // Compute distance using displayed/rounded distances from origin and integer bearings
    private static double displayedDistanceBetween(Airplane a, Airplane b) {
        double r1 = a.getRoundedDist();
        double r2 = b.getRoundedDist();
        int b1 = a.getBearing();
        int b2 = b.getBearing();
        double theta = Math.toRadians(Math.abs(b1 - b2));
...
class Airplane {
    ...
    // Public accessors for displayed calculations
    public double getRoundedDist() {
        return Math.round(distFromOrigin() * 100.0) / 100.0;
    }
